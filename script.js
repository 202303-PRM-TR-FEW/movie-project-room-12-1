	...
	.addEventListener('click', async function (event) {
		...
		if (event.target.className === 'genre-btn') {
			...
			<div class="slider-controls ">
				<button class="  text-white  rounded  hover:drop-shadow-md hover:bg-red-800 bg-red-600" onclick="prevSlide()">&#60;</button>
				<button class="  text-white rounded  hover:drop-shadow-md hover:bg-red-800 bg-red-600" onclick="nextSlide()">&#62;</button>
			</div>`;
